...
export const StartMenu = () => {
  ...
  return (
    <section className=" bg-white relative pb-[30vh] xl:pb-[30px] min-h-screen overflow-hidden xl:h-screen flex pt-32 lg:pt-10 font-bankgothic">
      {/* Hero content */}
      <div className="flex flex-wrap w-full pb-44 md:pb-20  items-center h-full gap-y-3  xl:justify-between px-5 lg:px-20 justify-center ">
        <div className="basis-full  py-10 z-30 flex flex-col items-center  textxl uppercase font-normal text-[#b5c0d5] tracking-[6px]  ">
          {menuItems.map((item) => (
            <button
              onMouseEnter={(e: React.MouseEvent<HTMLButtonElement, MouseEvent>) => play()}
              className="flex group relative w-92 uppercase"
            >
              <Image
                src={cross}
                alt="cross"
